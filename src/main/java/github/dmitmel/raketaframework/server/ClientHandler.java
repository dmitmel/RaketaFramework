...
import github.dmitmel.raketaframework.*;
import github.dmitmel.raketaframework.app.Document;
import github.dmitmel.raketaframework.app.Redirect;
import github.dmitmel.raketaframework.app.RequestParams;
import github.dmitmel.raketaframework.errors.*;
import github.dmitmel.raketaframework.routes.Route;
import github.dmitmel.raketaframework.routes.Router;
...
class ClientHandler implements Runnable {
    ...
    private void printRequest() {
        ...
        server.logger.log(LoggingLevel.SUMMARY, "%s -> %s, requested %d bytes", inetSocketAddress.getHostString(),
                incomingMessage.uri, requestLength);
