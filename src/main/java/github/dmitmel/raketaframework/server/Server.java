...
import github.dmitmel.raketaframework.errors.DefaultErrorResponderMapMaker;
import github.dmitmel.raketaframework.errors.ErrorResponder;
...
public class Server {
    ...
    private ServerSocket initServerSocket() {
        try {
            ...
            throw github.dmitmel.raketaframework.exceptions.UnknownHostException.extractFrom(e);
