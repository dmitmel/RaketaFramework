...
import github.dmitmel.raketaframework.util.JSONSerializer;
import org.junit.Assert;
import org.junit.Test;

import static github.dmitmel.raketaframework.util.JSONJavaDSL.*;

public class JSONMultilineSerializingTest extends Assert {
    @Test
    public void testNumbers() {
        ...
        String expected =
                ...
                "    \"long\": 3\n" +
                "}";
        assertEquals(expected, JSONSerializer.toMultilineJSON(tree));
    }
